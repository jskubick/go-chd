...
[ZoneTransfer]
ZoneId=3
HostUrl=(redacted, but it will look something like https://www.foo.com/downloads/whatev3r.zip)
zipfile-Name=(redacted, but based upon the above HostUrl, will probably be "whatev3r").zip
...
processedFile=(redacted, but based upon the above zipfile-Name, will probably be "whatev3r").iso
...
* zipfile-LastModified. Self-explanatory.
